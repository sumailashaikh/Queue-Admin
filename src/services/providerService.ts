...
export const providerService = {
  async getProviders(businessId?: string): Promise<ServiceProvider[]> {
    const url = businessId
      ? `/service-providers?business_id=${businessId}`
      : "/service-providers";
  ...
  async updateProvider(
    ...
    const result = await api.patch<ServiceProvider>(
  ...
  async getAvailability(providerId: string): Promise<any[]> {
    const result = await api.get<any[]>(
      `/service-providers/${providerId}/availability`,
    );
    return result.data || [];
  },
  ...
  async updateAvailability(
    ...
    await api.put(`/service-providers/${providerId}/availability`, {
      availability,
    });
  },

  async getAttendance(providerId: string): Promise<{ today: any | null; records: any[] }> {
    const result = await api.get<{ today: any | null; records: any[] }>(
      `/service-providers/${providerId}/attendance`,
    );
    return result.data || { today: null, records: [] };
  },

  async markAttendance(providerId: string, action: "clock_in" | "clock_out"): Promise<any> {
    const result = await api.post<any>(`/service-providers/${providerId}/attendance`, { action });
    return result.data;
  },

  async getDayOffs(providerId: string): Promise<any[]> {
    const result = await api.get<any[]>(
      `/service-providers/${providerId}/day-offs`,
    );
    return result.data || [];
  },
  ...
  async updateDayOff(
    ...
    const result = await api.patch<any>(`/service-providers/day-offs/${dayOffId}`, data);
    return result.data;
  },

  async getBlockTimes(providerId: string): Promise<any[]> {
    const result = await api.get<any[]>(
      `/service-providers/${providerId}/block-times`,
    );
    return result.data || [];
  },
  ...
  async updateBlockTime(
    ...
    const result = await api.patch<any>(`/service-providers/block-times/${blockId}`, data);
    return result.data;
  },
  ...
  async validateLeave(
    ...
    const result = await api.post<any>(
      `/service-providers/${providerId}/leaves/validate`,
      data,
    );
    return result;
  },

  async previewReassignPlan(
    providerId: string,
    data: {
      start_date: string;
      end_date: string;
    ...
    const result = await api.post<any>(
      `/service-providers/${providerId}/leaves/reassign-plan`,
      data,
    );
    return result;
  },

  async applyReassignPlan(
    providerId: string,
    assignments: { appointment_id: string; to_provider_id?: string | null }[],
  ): Promise<any> {
    const result = await api.post<any>(
      `/service-providers/${providerId}/leaves/reassign-apply`,
      { assignments },
    );
    return result;
  },
  ...
  async addLeave(
    ...
    const result = await api.post<any>(
      `/service-providers/${providerId}/leaves`,
      data,
    );
    return result;
  },
  ...
  async updateLeaveStatus(
    ...
    const result = await api.patch<any>(
      `/service-providers/leaves/${leaveId}/status`,
      { status, reason },
    );
    return result;
  },
